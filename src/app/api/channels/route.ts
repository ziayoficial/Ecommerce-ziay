...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    captureError(err as Error, { path: '/api/channels', method: 'GET' })
...
export async function POST(req: NextRequest) {
  try {
    ...
    captureError(err as Error, { path: '/api/channels', method: 'POST' })
    return NextResponse.json(
      { error: 'Internal server error', message: err instanceof Error ? err.message : 'Unknown error' },
      { status: 500 },
    )
...
export async function PATCH(req: NextRequest) {
  ...
  try {
    ...
    captureError(err as Error, { path: '/api/channels', method: 'PATCH' })
    return NextResponse.json(
      { error: 'Internal server error', message: err instanceof Error ? err.message : 'Unknown error' },
      { status: 500 },
    )
...
export async function DELETE(req: NextRequest) {
  ...
  try {
    ...
    captureError(err as Error, { path: '/api/channels', method: 'DELETE' })
    return NextResponse.json(
      { error: 'Internal server error', message: err instanceof Error ? err.message : 'Unknown error' },
      { status: 500 },
    )
