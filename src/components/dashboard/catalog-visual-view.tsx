            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr] h-full max-h-[85vh]">
              ...
              <div className="flex flex-col overflow-y-auto scroll-thin">
                <div className="aspect-square bg-muted relative">
                  {selectedProduct.imageUrl ? <img src={selectedProduct.imageUrl} alt={selectedProduct.name} className="w-full h-full object-cover" /> : <div className="w-full h-full flex items-center justify-center text-muted-foreground"><Package className="size-12" /></div>}
