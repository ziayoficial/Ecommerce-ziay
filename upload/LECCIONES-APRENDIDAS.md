...
**Contexto:** El fraudService en src/lib/services/fraud.service.ts (961 lineas) estaba integrado en 4 API routes pero 0 de los 65+ archivos de test lo probaban.
