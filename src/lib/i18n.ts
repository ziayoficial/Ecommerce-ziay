...
const translations: Record<Locale, Record<string, string>> = {
  'es-CO': {
    ...
    // ── SPRINT-FIXES-FINAL-001 — Wallet 2FA i18n keys ──
    'wallet.2fa_title': 'Autenticación de dos factores',
    'wallet.2fa_desc': 'Protege tus retiros con TOTP',
    'wallet.2fa_secret': 'Secreto 2FA',
    'wallet.2fa_backup_codes': 'Códigos de respaldo',
    'wallet.2fa_verify_code': 'Código de verificación',
    'wallet.2fa_activate': 'Activar 2FA',
    'wallet.2fa_disable': 'Desactivar 2FA',
    'wallet.2fa_verified': '2FA verificado',
    'wallet.2fa_pending': 'Pendiente de verificación',
    'wallet.2fa_scan_qr': 'Escanea este código QR con tu app autenticadora',
    'wallet.2fa_enter_code': 'Ingresa el código de 6 dígitos',
    'wallet.2fa_verify': 'Verificar',
    'wallet.2fa_save_codes': 'Guarda estos códigos en un lugar seguro',
  },
  'es-MX': {
  ...
  'en-US': {
    ...
    // ── SPRINT-FIXES-FINAL-001 — Wallet 2FA i18n keys ──
    'wallet.2fa_title': 'Two-factor authentication',
    'wallet.2fa_desc': 'Protect your withdrawals with TOTP',
    'wallet.2fa_secret': '2FA Secret',
    'wallet.2fa_backup_codes': 'Backup codes',
    'wallet.2fa_verify_code': 'Verification code',
    'wallet.2fa_activate': 'Activate 2FA',
    'wallet.2fa_disable': 'Disable 2FA',
    'wallet.2fa_verified': '2FA verified',
    'wallet.2fa_pending': 'Pending verification',
    'wallet.2fa_scan_qr': 'Scan this QR code with your authenticator app',
    'wallet.2fa_enter_code': 'Enter the 6-digit code',
    'wallet.2fa_verify': 'Verify',
    'wallet.2fa_save_codes': 'Save these codes in a safe place',
  },
  'pt-BR': {
    'app.name': 'ZIAY',
    ...
    // ── SPRINT-FIXES-FINAL-001 — Wallet 2FA i18n keys ──
    'wallet.2fa_title': 'Autenticação de dois fatores',
    'wallet.2fa_desc': 'Proteja seus saques com TOTP',
    'wallet.2fa_secret': 'Segredo 2FA',
    'wallet.2fa_backup_codes': 'Códigos de backup',
    'wallet.2fa_verify_code': 'Código de verificação',
    'wallet.2fa_activate': 'Ativar 2FA',
    'wallet.2fa_disable': 'Desativar 2FA',
    'wallet.2fa_verified': '2FA verificado',
    'wallet.2fa_pending': 'Pendente de verificação',
    'wallet.2fa_scan_qr': 'Escaneie este código QR com seu app autenticador',
    'wallet.2fa_enter_code': 'Digite o código de 6 dígitos',
    'wallet.2fa_verify': 'Verificar',
    'wallet.2fa_save_codes': 'Salve estes códigos em um lugar seguro',
  },
}
